...
namespace Logistic
{
    public partial class employee_Ask_for_Vehicle : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectAskForVehiclebyCircle(Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectAskForVehiclebyCircle(Convert.ToInt32(Session["EmployeeId"]));
