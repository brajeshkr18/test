...
namespace Logistic
{
    public partial class admin_RequestVehicle : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectVehicleRequest(0);
        ...
        {
            DataTable dt = new DataManager().SelectVehicleRequest(0);
