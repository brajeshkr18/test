...
namespace Logistic
{
    public partial class employee_NewConsignment : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectConsignmentbyCircle1(Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectConsignmentbyCircle(Convert.ToInt32(Session["EmployeeId"]));
