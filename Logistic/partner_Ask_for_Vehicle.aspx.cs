...
namespace Logistic
{
    public partial class partner_Ask_for_Vehicle : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectAskForVehiclebyPartnerId(Convert.ToInt32(Session["PartnerId"]));
        ...
        {
            DataTable dt = new DataManager().SelectAskForVehiclebyPartnerId(Convert.ToInt32(Session["PartnerId"]));
