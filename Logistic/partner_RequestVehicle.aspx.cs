...
namespace Logistic
{
    public partial class partner_RequestVehicle : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectVehicleRequestbyPartnerId(Convert.ToInt32(Session["PartnerId"]));
        ...
        {
            DataTable dt = new DataManager().SelectVehicleRequestbyPartnerId(Convert.ToInt32(Session["PartnerId"]));
