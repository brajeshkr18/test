...
namespace Logistic
{
    public partial class admin_home_Bill : System.Web.UI.Page
    {
        ...
        {
            DataTable dt1 = new DataManager().CountTotalBill(0);
            if (dt1.Rows.Count > 0)
            {
            ...
            DataTable dt3 = new DataManager().CountInvoicebyStatusAndCircle("Pending", 0);
            if (dt3.Rows.Count > 0)
            {
            ...
            DataTable dt4 = new DataManager().CountInvoicebyStatusAndCircle("Reject", 0);
            if (dt4.Rows.Count > 0)
            {
            ...
            DataTable dt5 = new DataManager().CountInvoicebyStatusAndCircle("Accept", 0);
            if (dt5.Rows.Count > 0)
            {
