...
namespace Logistic
{
    public partial class admin_Today_Consignement : System.Web.UI.Page
    {
        ...
        public void BindDataList()
        {
            ...
            DataTable data = new DataManager().SelectConsignmentbyToday(date);
        ...
        private void SearchText()
        {
            ...
            string Year = d.ToString("yyyy");
            string date = Month + "/" + day + "/" + Year;
            DataTable dt = new DataManager().SelectConsignmentbyToday(date);
