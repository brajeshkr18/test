<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_Today_Vehicle_Request.aspx.cs" Inherits="Logistic.employee_Today_Vehicle_Request" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function DeleteItem() {
        if (confirm("Are you sure you want to delete Vehicle Request ...?")) {
            return true;
        }
        return false;
    }
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Today Vehicle Request</h2>
									</header>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Today Vehicle Request List</h2>
									</header>
									<div class="panel-body">
