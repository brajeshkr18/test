<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="admin_RequestVehicle.aspx.cs" Inherits="Logistic.admin_RequestVehicle" %>
								...
								<section class="panel">
									...
									<div class="panel-body">
                                     ...
                                     <footer class="panel-footer">
                                           ...
                                           <asp:Button ID="btnSendmail" OnClick="btnSendmail_Click" visible="False" runat="server" Text="Send Mail"  
                                               CssClass="mb-xs mt-xs mr-xs btn btn-primary" ></asp:Button>    
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Vehicle Request List</h2>
									</header>
									<div class="panel-body">
