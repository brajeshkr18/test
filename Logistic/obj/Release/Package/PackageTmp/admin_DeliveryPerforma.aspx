<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="admin_DeliveryPerforma.aspx.cs" Inherits="Logistic.admin_DeliveryPerforma" %>
 ...
 <asp:View ID="View1" runat="server"> 
    ...
    <ContentTemplate>
                                    	<div class="form-group">
											...
											<div class="col-sm-8">
                                            <%-- <asp:TextBox ID="txtConsignementID" class="form-control" runat="server" 
                                                    AutoPostBack="True" ontextchanged="txtConsignementID_TextChanged"></asp:TextBox>--%>
                                                ...
                                                <asp:DropDownList ID="ddConsignementID"  AutoPostBack="True" class="form-control"  
                                                    runat="server" onselectedindexchanged="ddConsignementID_SelectedIndexChanged1">
                                                        ...
                                                        <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                                                     ControlToValidate="txtConsignementID" ErrorMessage="Please Enter Consignement ID"
