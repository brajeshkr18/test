<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_home_Consignement.aspx.cs" Inherits="Logistic.employee_home_Consignement" %>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										...
										<div class="panel-body">
											<div class="widget-summary">
                                               <a href="employee_Today_Consignement.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_Today_Consignement.aspx">(View Today)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_NewConsignment.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_NewConsignment.aspx">(View All)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_OldConsignmentClient.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_OldConsignmentClient.aspx">(View Old)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                              <a href="employee_OngoingConsignmentClient.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_OngoingConsignmentClient.aspx">(View )</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_ConsignementTracking.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_ConsignementTracking.aspx">(View )</a>
													</div>
												</div>
											</div>
										</div>
