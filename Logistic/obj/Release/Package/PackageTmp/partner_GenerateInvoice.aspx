<%@ Page Title="" Language="C#" MasterPageFile="~/partner.Master" AutoEventWireup="true" enableEventValidation="false"
    CodeBehind="partner_GenerateInvoice.aspx.cs" Inherits="Logistic.partner_GenerateInvoice" %>
										...
										<form class="form-horizontal form-bordered" action="#">
                                            ...
                                            <div class="form-group">
											 ...
											 <div class="form-group">
												...
												<div class="col-md-6">
                                                    <asp:TextBox ID="txtSRNNo" class="form-control" runat="server" 
                                                        AutoPostBack="True" ontextchanged="txtSRNNo_TextChanged"></asp:TextBox>
                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                                                                     ControlToValidate="txtSRNNo" ErrorMessage="Please Enter SRN No" ForeColor="Red" ValidationGroup="abc"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="form-group">
											<label class="col-sm-3 control-label">Consigner Name: </label>
											<div class="col-sm-6">
                                          ...
                                          <div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" runat="server" id="txtPeriod">
												</div>
											</div>
                                             ...
                                             <div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" runat="server" onkeypress="return isNumberKey(event)" id="txtAmount">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                                     ControlToValidate="txtAmount" ErrorMessage="*" ForeColor="Red" ValidationGroup="abc"></asp:RequiredFieldValidator>
												</div>
											</div>
                                            <div class="form-group">
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Generate Bill List</h2>
									</header>
									<div class="panel-body">
                    ...
                    onrowcommand="gridState_RowCommand" PageSize="30" >
                        ...
                        <Columns>     
                         ...
                         <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                            ...
                            <asp:TemplateField HeaderText="Name Of Circle" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                             ...
                             <%-- <asp:TemplateField HeaderText="Consigner Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                    <asp:Label ID="lblNameOfAccount" runat="server" Text='<%#Eval("stateName") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" CssClass="style1"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"  Width="11%" CssClass="style1"></ItemStyle>
                            </asp:TemplateField>   --%>  
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Actions" ItemStyle-VerticalAlign="Top">
                                                    <ItemTemplate>
                                                    <div class="btn-group">
                                                   <asp:LinkButton ID="lnkPrint" runat="server" CssClass="btn btn-default" CommandName="Print" Font-Size="18px" Visible="false" CommandArgument='<%#Eval("Id")%>'  AlternateText="Print"><i class="fa fa-print" aria-hidden="true"></i></asp:LinkButton>
