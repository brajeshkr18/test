<%@ Page Title="" Language="C#" MasterPageFile="~/partner.Master" AutoEventWireup="true" CodeBehind="partner_OldInvoice.aspx.cs" Inherits="Logistic.partner_OldInvoice" %>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Pending Bill</h2>
									</header>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Pending Bill List</h2>
									</header>
									<div class="panel-body">
                         ...
                         <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                             ...
                             <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                              ...
                              <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                    <span class="label label-warning"><asp:Label ID="lblStatus" runat="server" Text='<%#Eval("Status") %>'></asp:Label></span>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" CssClass="style1"></HeaderStyle>
