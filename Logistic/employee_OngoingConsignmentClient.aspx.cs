...
namespace Logistic
{
    public partial class employee_OngoingConsignmentClient : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = new DataManager().SelectConsignmentbyStatusAndCircle("Pending", Convert.ToInt32(Session["EmployeeId"]));
            if (dt.Rows.Count != 0)
            {
