<%@ Page Title="" Language="C#" MasterPageFile="~/partner.Master" AutoEventWireup="true" CodeBehind="partner_Today_Ask_For_Vehicle.aspx.cs" Inherits="Logistic.partner_Today_Ask_For_Vehicle" %>
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="#">
                                         ...
                                         <div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" runat="server" id="txtRequestNo">
												</div>
											</div>
											<div class="form-group">
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Today, Ask For Vehicle List</h2>
									</header>
									<div class="panel-body">
