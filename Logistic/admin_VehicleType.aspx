<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="admin_VehicleType.aspx.cs" Inherits="Logistic.admin_VehicleType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function DeleteItem() {
        if (confirm("Are you sure you want to delete Vehicle Type ...?")) {
            return true;
        }
        return false;
    }
       ...
       <div class="col-sm-6 portlets ui-sortable">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Vehicle Type Form</h2>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Vehicle Type</h2>
									</header>
									<div class="panel-body">
        ...
        AutoGenerateColumns="False" CellPadding="4" BorderWidth="1px"
                    ...
                    onrowcommand="gridState_RowCommand" PageSize="30" >
                        ...
                        <Columns>   
                         <asp:TemplateField HeaderText = "S.No."  HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                            ...
                            <asp:TemplateField HeaderText="Vehicle Type " HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                ...
                                <HeaderStyle HorizontalAlign="Left" CssClass="style1"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"  Width="80%" CssClass="style1"></ItemStyle>
                            </asp:TemplateField>           
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Actions" ItemStyle-VerticalAlign="Top">
                                                 ...
                                                 <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"  Width="17%" ></ItemStyle>
                        </asp:TemplateField>
