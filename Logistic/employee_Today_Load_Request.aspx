<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_Today_Load_Request.aspx.cs" Inherits="Logistic.employee_Today_Load_Request" %>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Today Load Request</h2>
									</header>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Today Load Request List</h2>
									</header>
									<div class="panel-body">
