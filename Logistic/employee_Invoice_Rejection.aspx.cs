...
namespace Logistic
{
    public partial class employee_Invoice_Rejection : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyStatusAndCircle("Reject", Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyStatusAndCircle("Reject", Convert.ToInt32(Session["EmployeeId"]));
