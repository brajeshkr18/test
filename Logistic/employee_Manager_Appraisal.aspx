<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_Manager_Appraisal.aspx.cs" Inherits="Logistic.employee_Manager_Appraisal" %>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Manager Appraisal</h2>
									</header>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Manager Appraisal List</h2>
									</header>
									<div class="panel-body">
                    ...
                    onrowcommand="gridState_RowCommand" PageSize="30" >
                        ...
                        <Columns>     
                         ...
                         <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                              ...
                              <asp:TemplateField HeaderText="Manager" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
