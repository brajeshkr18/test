...
namespace Logistic
{
    public partial class employee_GenerateInvoice : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyCircle(Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyCircle(Convert.ToInt32(Session["EmployeeId"]));
