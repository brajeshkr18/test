...
namespace Logistic
{
    public partial class admin_OldInvoice : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyStatus("Pending");
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyStatus("Pending");
