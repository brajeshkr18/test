...
namespace Logistic
{
    public partial class admin_Today_Vehicle_Request : System.Web.UI.Page
    {
        ...
        public void BindDataList()
        {
            ...
            DataTable data = new DataManager().SelectVehicleRequestbyCircleToday(0, today);
        ...
        {
            string today = DateTime.Now.ToString("yyyy-MM-dd");
            DataTable dt = new DataManager().SelectVehicleRequestbyCircleToday(0, today);
