...
namespace Logistic
{
    public partial class partner_InvoiceAccepted : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyPartnerId(Convert.ToInt32(Session["PartnerId"]), "Accept");
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyPartnerId(Convert.ToInt32(Session["PartnerId"]), "Accept");
