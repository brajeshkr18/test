<%@ Page Title="" Language="C#" MasterPageFile="~/partner.Master" AutoEventWireup="true" CodeBehind="partner_Invoice_Rejection.aspx.cs" Inherits="Logistic.partner_Invoice_Rejection" %>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Rejection Bill</h2>
									</header>
									<div class="panel-body">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-6">
                                             <input id="txtDateOfReview" runat="server" readonly="readonly" type="text"  class="form-control">
                                              </div>
										</div>
                                         <div class="form-group">
											<label class="col-sm-3 control-label">Rejection Remark: </label>
											<div class="col-sm-6">
												  <textarea id="txtRejectionRemark" runat="server" readonly="readonly" name="example-text-input" class="form-control" cols="20" rows="5"></textarea>
                                     ...
                                     <footer class="panel-footer">
                                            <asp:LinkButton ID="btnsubmit" onclick="btnsubmit_Click1" ValidationGroup="abc" CssClass="mb-xs mt-xs mr-xs btn btn-primary" runat="server"> Back</asp:LinkButton>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Rejection Bill List</h2>
									</header>
									<div class="panel-body">
                        ...
                        <Columns>     
                         ...
                         <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                              ...
                              <asp:TemplateField HeaderText="Name Of Account" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                ...
                                <HeaderStyle HorizontalAlign="Left" CssClass="style1"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"  Width="16%" CssClass="style1"></ItemStyle>
                            </asp:TemplateField>     
                             ...
                             <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                              ...
                              <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                   <span class="label label-danger"><asp:Label ID="lblStatus" runat="server" Text='<%#Eval("Status") %>'></asp:Label></span>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" CssClass="style1"></HeaderStyle>
