...
namespace Logistic
{
    public partial class partner_Invoice_Rejection : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyPartnerId(Convert.ToInt32(Session["PartnerId"]), "Reject");
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyPartnerId(Convert.ToInt32(Session["PartnerId"]), "Reject");
