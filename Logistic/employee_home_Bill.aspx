<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_home_Bill.aspx.cs" Inherits="Logistic.employee_home_Bill" %>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										...
										<div class="panel-body">
											<div class="widget-summary">
                                               <a href="employee_Today_GenerateInvoice.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_Today_GenerateInvoice.aspx">(View Today)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_GenerateInvoice.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_GenerateInvoice.aspx">(View All)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_OldInvoice.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_OldInvoice.aspx">(View Pending)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                              <a href="employee_Invoice_Rejection.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_Invoice_Rejection.aspx">(View Reject)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_InvoiceAccepted.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_InvoiceAccepted.aspx">(View Accept)</a>
													</div>
												</div>
											</div>
										</div>
