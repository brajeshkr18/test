<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_Today_Consignement.aspx.cs" Inherits="Logistic.employee_Today_Consignement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function DeleteItem() {
        if (confirm("Are you sure you want to delete  Consignement ...?")) {
            return true;
        }
        return false;
    }
       ...
       <div class="col-sm-12 portlets ui-sortable">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title"> Today Consignement </h2>
										...
										<hr />
                                          ...
                                          <div class="form-group">
											...
											<div class="col-sm-8">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" ControlToValidate="txtContact1" Height="2px" Font-Size="Small" runat="server"  ErrorMessage="Please Enter Correct Contact No " ForeColor="Red" ValidationGroup="abc" ValidationExpression="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"></asp:RegularExpressionValidator>
                                     ...
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-8">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtContactNumber1" Height="2px" Font-Size="Small" runat="server"  ErrorMessage="Please Enter Correct Contact No " ForeColor="Red" ValidationGroup="abc" ValidationExpression="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"></asp:RegularExpressionValidator>
                                         ...
                                         <div class="form-group">
											...
											<div class="col-sm-8">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txtContactNumber2" Height="2px" Font-Size="Small" runat="server"  ErrorMessage="Please Enter Correct Contact No " ForeColor="Red" ValidationGroup="abc" ValidationExpression="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"></asp:RegularExpressionValidator>
                                         ...
                                         <div class="form-group">
											...
											<div class="col-sm-8">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="txtContactNumber3" Height="2px" Font-Size="Small" runat="server"  ErrorMessage="Please Enter Correct Contact No " ForeColor="Red" ValidationGroup="abc" ValidationExpression="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"></asp:RegularExpressionValidator>
                                         ...
                                         <div class="form-group">
											...
											<div class="col-sm-8">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ControlToValidate="txtContactNumber4" Height="2px" Font-Size="Small" runat="server"  ErrorMessage="Please Enter Correct Contact No " ForeColor="Red" ValidationGroup="abc" ValidationExpression="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"></asp:RegularExpressionValidator>
