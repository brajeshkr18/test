...
namespace Logistic
{
    public partial class employee_Today_Vehicle_Request : System.Web.UI.Page
    {
        ...
        public void BindDataList()
        {
            ...
            DataTable data = new DataManager().SelectVehicleRequestbyCircleToday(Convert.ToInt32(Session["EmployeeId"]), today);
        ...
        {
            string today = DateTime.Now.ToString("yyyy-MM-dd");
            DataTable dt = new DataManager().SelectVehicleRequestbyCircleToday(Convert.ToInt32(Session["EmployeeId"]), today);
