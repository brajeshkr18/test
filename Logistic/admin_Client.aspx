<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="admin_Client.aspx.cs" Inherits="Logistic.admin_Client" %>
       ...
       <div class="col-sm-6 portlets ui-sortable">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Client Form</h2>
									...
									<div class="panel-body">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
											...
											<div class="col-sm-8">
												 <input type="text" id="txtUserId" runat="server" class="form-control placeholder-no-fix" placeholder="Client Id (Login Id)">
  ...
  <asp:View ID="View2" runat="server">
        ...
        <div class="col-md-12">
						<div class="widget">
                            ...
                            <label><div class="input-group">
                              <asp:TextBox ID="txtSearch" runat="server" class="form-control"  AutoPostBack="True" placeholder="Search" Height="42px" ontextchanged="txtSearch_TextChanged"></asp:TextBox>
   ...
   <asp:GridView ID="GridView1" Visible="true" HeaderStyle-BackColor="#000" HeaderStyle-ForeColor="White"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ClientName" HeaderText="Client Name" ItemStyle-Width="150px" />
