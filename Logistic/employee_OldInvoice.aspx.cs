...
namespace Logistic
{
    public partial class employee_OldInvoice : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyStatusAndCircle("Pending", Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyStatusAndCircle("Pending", Convert.ToInt32(Session["EmployeeId"]));
