<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConsignementTrackingReport.aspx.cs" Inherits="Logistic.ConsignementTrackingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <!-- .page-title start -->
        ...
        <div class="page-content">
            <div class="container">
                <div class="row">
                    <img src="img/forms/ConsignementTrackingReport.jpg" />
                </div><!-- .row end -->
            </div><!-- .container end -->
