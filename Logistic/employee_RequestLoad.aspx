<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true"  EnableEventValidation="false"
     CodeBehind="employee_RequestLoad.aspx.cs" Inherits="Logistic.employee_RequestLoad" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function DeleteItem() {
        if (confirm("Are you sure you want to delete Book Load Request ...?")) {
            return true;
        }
        return false;
    }
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Book Load Request</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="#">
                                            <div class="form-group">
												    ...
												    <div class="col-md-6">
													     <asp:DropDownList ID="ddlClient" class="form-control populate" runat="server">
                                                         </asp:DropDownList>
												    </div>
											    </div>
											<div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Post By</label>
												<div class="col-md-6">
													<input type="text" class="form-control" readonly="readonly" runat="server" id="txtType">
												</div>
											</div>
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Name</label>
												<div class="col-md-6">
													<input type="text" class="form-control" readonly="readonly" runat="server" id="txtName">
												</div>
											</div>
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Mobile No</label>
												<div class="col-md-6">
													<input type="text" class="form-control" readonly="readonly" runat="server" id="txtMobile">
												</div>
											</div>
                                             <div class="form-group">
                                               ...
                                               <div class="form-group" >
												<label class="col-md-3 control-label" for="inputDefault" runat="server" id="lblEmailId"  visible="false">EmailId</label>
												<div class="col-md-6">
													<input type="text" class="form-control" runat="server" id="txtemail" visible="false"/>
												</div>
											</div>
										</form>
                                     ...
                                     <footer class="panel-footer">
                                          ...
                                          <asp:Button ID="btnSendmail" OnClick="btnSendmail_Click" visible="False" runat="server" Text="Send Mail"  CssClass="mb-xs mt-xs mr-xs btn btn-primary" ></asp:Button>        
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Book Load Request List</h2>
									</header>
									<div class="panel-body">
                    ...
                    onrowcommand="gridState_RowCommand" PageSize="30" >
                        ...
                        <Columns>     
                         ...
                         <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                             ...
                             <asp:TemplateField HeaderText="Client" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Post by" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                    <asp:Label ID="lblPost" runat="server" Text='<%#Eval("postBy") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" CssClass="style1"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"  Width="12%" CssClass="style1"></ItemStyle>
                            </asp:TemplateField> 
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Actions" ItemStyle-VerticalAlign="Top">
                                                 ...
                                                 <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"  Width="13%" ></ItemStyle>
                        </asp:TemplateField>
