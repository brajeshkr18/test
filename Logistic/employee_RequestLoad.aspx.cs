...
namespace Logistic
{
    public partial class employee_RequestLoad : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectLoadRequestbyCircle(Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectLoadRequestbyCircle(Convert.ToInt32(Session["EmployeeId"]));
