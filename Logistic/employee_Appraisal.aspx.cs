...
namespace Logistic
{
    public partial class employee_Appraisal : System.Web.UI.Page
    {
        ...
        public void BindDataList()
        {
            ...
            DataTable data = new DataManager().SelectEmployeeAppraisalbyEmployeeId(Convert.ToInt32(Session["EmployeeId"]));
            ...
            if (dt1.Rows.Count > 0)
            {
                string Max = dt1.Rows[0]["id"].ToString();
                ...
                if (dt2.Rows.Count > 0)
                {
                    ...
                    {
                        lnkAdd.Visible = true;
                        if (new DataManager().checkEmployeeAppraisal(Convert.ToInt32(Session["EmployeeId"]), 0, from, To) == 1)
                        {
                            lnkAdd.Visible = true;
                        }
                        else
        ...
        {
            DataTable dt = new DataManager().SelectEmployeeAppraisalbyEmployeeId(Convert.ToInt32(Session["EmployeeId"]));
