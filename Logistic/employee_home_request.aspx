<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_home_request.aspx.cs" Inherits="Logistic.employee_home_request" %>
...
<div class="row">
									...
									<section class="panel panel-featured-left panel-featured-primary">
										...
										<div class="panel-body">
											<div class="widget-summary">
                                               <a href="employee_Today_Load_Request.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_Today_Load_Request.aspx">(View Today)</a>
													</div>
												</div>
											</div>
										</div>
                                ...
                                <div class="col-md-8 col-lg-4 col-xl-4">
									<section class="panel panel-featured-left panel-featured-tertiary">
										<div class="panel-body">
											<div class="widget-summary">
                                             <a href="employee_Today_Vehicle_Request.aspx">
												<div class="widget-summary-col widget-summary-col-icon">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_Today_Vehicle_Request.aspx">(View Today)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                             <a href="employee_RequestLoad.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_RequestLoad.aspx">(View All)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
                                              <a href="employee_RequestVehicle.aspx">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="employee_RequestVehicle.aspx">(View All)</a>
													</div>
												</div>
											</div>
										</div>
