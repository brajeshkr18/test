...
namespace Logistic
{
    public partial class admin_Invoice_Rejection : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyStatus("Reject");
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyStatus("Reject");
