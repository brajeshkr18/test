...
namespace Logistic
{
    public partial class admin_Today_GenerateInvoice : System.Web.UI.Page
    {
        ...
        public void BindDataList()
        {
            ...
            DataTable data = new DataManager().SelectInvoicebyCircleToday(0, today);
        ...
        {
            string today = DateTime.Now.ToString("yyyy-MM-dd");
            DataTable dt = new DataManager().SelectInvoicebyCircleToday(0, today);
