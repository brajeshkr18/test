<%@ Page Title="" Language="C#" MasterPageFile="~/employee.Master" AutoEventWireup="true" CodeBehind="employee_employee_Appraisal.aspx.cs" Inherits="Logistic.employee_employee_Appraisal" %>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Employee Appraisal</h2>
									</header>
									<div class="panel-body">
                                        ...
                                        <div class="col-sm-6">
                                          <div class="form-group">
												    ...
												    <div class="col-md-6">
													     <asp:DropDownList ID="ddlEmployee" class="form-control populate" 
                                        ...
                                        <hr />
                                            ...
                                            <hr />
                                             <div class="form-group">
												    ...
												    <div class="col-md-6">
													     <asp:DropDownList ID="ddlManager" Enabled="false" class="form-control populate" runat="server">
                                                         </asp:DropDownList>
                                        ...
                                        <hr />
                                            ...
                                            <div class="form-group">
												    <label class="col-md-3 control-label">Rating </label>
												    <div class="col-md-6" >
													    <asp:Rating ID="Rating6" runat="server" Height="20px" StarCssClass="ratingStar"  WaitingStarCssClass="savedStar"
                                                                FilledStarCssClass="filledStar" EmptyStarCssClass="emptyStar" CurrentRating="0" MaxRating="5"></asp:Rating>
												    </div>
											 ...
											 <div class="form-group">
												...
												<div class="col-md-6">
													 <label><span style="color:#F00;">&nbsp;</span></label>	
                                                        <div style="float:left">You rated 
                                                            <asp:Label ID="lbl_point_emp1" ForeColor="Red" Font-Bold="true" runat="server"></asp:Label></div>
                                             ...
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="textareaAutosize">Remark</label>
												<div class="col-md-6">
													<textarea class="form-control" readonly="readonly" rows="4" runat="server" id="txtRemark_Emp1" ></textarea>
                                             ...
                                             <div class="form-group">
												    <label class="col-md-3 control-label">Rating </label>
												    <div class="col-md-6">
													    <asp:Rating ID="Rating7" runat="server"  Height="20px" StarCssClass="ratingStar" WaitingStarCssClass="savedStar"
                                                                FilledStarCssClass="filledStar" EmptyStarCssClass="emptyStar"  CurrentRating="0" MaxRating="5" ></asp:Rating>
												    </div>
											 ...
											 <div class="form-group">
												...
												<div class="col-md-6">
													 <label><span style="color:#F00;">&nbsp;</span></label>	
                                                        <div style="float:left">You rated 
                                                            <asp:Label ID="lbl_point_emp2" ForeColor="Red" Font-Bold="true" runat="server"></asp:Label></div>
                                             ...
                                             <div class="form-group">
												<label class="col-md-3 control-label"  for="textareaAutosize">Remark</label>
												<div class="col-md-6">
													<textarea class="form-control" readonly="readonly" rows="4" runat="server" id="txtRemark_Emp2" ></textarea>
                                             ...
                                             <div class="form-group">
												    <label class="col-md-3 control-label">Rating </label>
												    <div class="col-md-6">
													    <asp:Rating ID="Rating8" runat="server" Height="20px" StarCssClass="ratingStar" WaitingStarCssClass="savedStar"
                                                                FilledStarCssClass="filledStar" EmptyStarCssClass="emptyStar"  CurrentRating="0" MaxRating="5"></asp:Rating>
												    </div>
											 ...
											 <div class="form-group">
												...
												<div class="col-md-6">
													 <label><span style="color:#F00;">&nbsp;</span></label>	
                                                        <div style="float:left">You rated 
                                                            <asp:Label ID="lbl_point_emp3" ForeColor="Red" Font-Bold="true" runat="server"></asp:Label></div>
                                             ...
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="textareaAutosize">Remark</label>
												<div class="col-md-6">
													<textarea class="form-control" readonly="readonly" rows="4" runat="server" id="txtRemark_Emp3" ></textarea>
                                             ...
                                             <div class="form-group">
												    <label class="col-md-3 control-label">Rating </label>
												    <div class="col-md-6">
													    <asp:Rating ID="Rating9" runat="server" Height="20px" StarCssClass="ratingStar" WaitingStarCssClass="savedStar"
                                                                FilledStarCssClass="filledStar" EmptyStarCssClass="emptyStar"  CurrentRating="0" MaxRating="5" ></asp:Rating>
												    </div>
											 ...
											 <div class="form-group">
												...
												<div class="col-md-6">
													 <label><span style="color:#F00;">&nbsp;</span></label>	
                                                        <div style="float:left">You rated 
                                                            <asp:Label ID="lbl_point_emp4" ForeColor="Red" Font-Bold="true" runat="server"></asp:Label></div>
                                             ...
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="textareaAutosize">Remark</label>
												<div class="col-md-6">
													<textarea class="form-control" readonly="readonly" rows="4" runat="server" id="txtRemark_Emp4" ></textarea>
                                             ...
                                             <div class="form-group">
												    <label class="col-md-3 control-label">Rating </label>
												    <div class="col-md-6">
													    <asp:Rating ID="Rating10" runat="server" Height="20px" StarCssClass="ratingStar" WaitingStarCssClass="savedStar"
                                                                FilledStarCssClass="filledStar" EmptyStarCssClass="emptyStar"  CurrentRating="0" MaxRating="5" ></asp:Rating>
												    </div>
											 ...
											 <div class="form-group">
												...
												<div class="col-md-6">
													 <label><span style="color:#F00;">&nbsp;</span></label>	
                                                        <div style="float:left">You rated 
                                                            <asp:Label ID="lbl_point_emp5" ForeColor="Red" Font-Bold="true" runat="server"></asp:Label></div>
                                             ...
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="textareaAutosize">Remark</label>
												<div class="col-md-6">
													<textarea class="form-control" readonly="readonly" rows="4" runat="server" id="txtRemark_Emp5" ></textarea>
                                             ...
                                             <div class="form-group">
												<label class="col-md-3 control-label" for="textareaAutosize">Other</label>
												<div class="col-md-6">
													<textarea class="form-control" rows="6" readonly="readonly" runat="server" id="txtOther_Emp" ></textarea>
                                     ...
                                     <footer class="panel-footer">
                                             <asp:LinkButton ID="btnsubmit" onclick="btnsubmit_Click1" 
                                    CssClass="mb-xs mt-xs mr-xs btn btn-primary" ValidationGroup="abc" 
                                    runat="server" Enabled="False"> Submit</asp:LinkButton>
                                            <asp:LinkButton ID="btnCancel" onclick="btnCancel_Click" CssClass="mb-xs mt-xs mr-xs btn btn-primary" runat="server"> Cancel</asp:LinkButton>
                                             ...
                                             <input type="hidden" id="txtLevel" runat="server" >
                                             <input type="hidden" id="txtDesignation" runat="server" >
                                             <input type="hidden" id="txtFileUpload" runat="server" >
                                             <input type="hidden" id="txtFrom" runat="server" >
                                             <input type="hidden" id="txtTo" runat="server" >
                                     </footer>
								</section>
							</div>
						</div>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Employee Appraisal List</h2>
									</header>
									<div class="panel-body">
        ...
        AutoGenerateColumns="False" CellPadding="4" BorderWidth="1px"
                    ...
                    onrowcommand="gridState_RowCommand" PageSize="30" >
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Actions" ItemStyle-VerticalAlign="Top">
                                                   ...
                                                   <asp:LinkButton ID="lnkEdit" runat="server" CssClass="btn btn-default" CommandName="Edit1" Font-Size="18px" Visible="false" CommandArgument='<%#Eval("Id")%>'  AlternateText="Edit"><i class="fa fa-edit"></i></asp:LinkButton>
                                                   <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete1" CssClass="btn btn-default" Font-Size="18px" Visible="false"  CommandArgument='<%#Eval("Id") %>' onclientclick="return DeleteItem()"  AlternateText="Delete"><i class="fa fa-power-off"></i></asp:LinkButton>        
                                                   </div>
                                                    </ItemTemplate>
