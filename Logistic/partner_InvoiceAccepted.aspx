<%@ Page Title="" Language="C#" MasterPageFile="~/partner.Master" AutoEventWireup="true" CodeBehind="partner_InvoiceAccepted.aspx.cs" Inherits="Logistic.partner_InvoiceAccepted" %>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Accept Bill</h2>
									</header>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Accept Bill List</h2>
									</header>
									<div class="panel-body">
