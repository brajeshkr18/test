<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="admin_RequestLoad.aspx.cs" Inherits="Logistic.admin_RequestLoad" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function DeleteItem() {
        if (confirm("Are you sure you want to delete Load Request ...?")) {
            return true;
        }
        return false;
    }
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Load Request</h2>
									</header>
									<div class="panel-body">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" runat="server" id="txtMobile">
												</div>
											</div>
                                             <div class="form-group">
                                     ...
                                     <div class="panel-footer">
                                      ...
                                      <asp:LinkButton ID="btnSendmail" autopostback="true" onclick="btnSendmail_Click1" visible="False" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary">Send Mail</asp:LinkButton>
                            ...
                            <div class="col-md-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Load Request List</h2>
									</header>
									<div class="panel-body">
