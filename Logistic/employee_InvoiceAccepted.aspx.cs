...
namespace Logistic
{
    public partial class employee_InvoiceAccepted : System.Web.UI.Page
    {
        ...
        {
            DataTable data = new DataManager().SelectInvoicebyStatusAndCircle("Accept", Convert.ToInt32(Session["EmployeeId"]));
        ...
        {
            DataTable dt = new DataManager().SelectInvoicebyStatusAndCircle("Accept", Convert.ToInt32(Session["EmployeeId"]));
